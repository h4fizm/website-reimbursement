@extends('main')
@section('title', 'Laman Detail Pengajuan Finance')
@section('nama_laman', 'Detail Informasi Pengajuan Finance')
@section('content')
            ...
            @endif
                  ...
                  <div class="row-md-3">
                    ...
                    <div class="row mt-3 justify-content-between">
                        <div class="col-md-6">
                            <a href="{{ route('daftar-pengajuan-finance') }}" class="btn btn-secondary">Kembali</a>
                        </div>
                        <div class="col-md-6 text-md-end">
                            <form action="{{ route('update-status-finance', ['id' => $pengajuan->id]) }}" method="POST" style="display: inline;">
                                @csrf
