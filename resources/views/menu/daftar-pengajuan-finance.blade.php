            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-secondary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                        <h6 class="text-white text-capitalize ps-3">Data Pengajuan ke Finance</h6>
                    </div>
                </div>
                {{-- Daftar Pengajuan Finance --}}
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                         <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                    @foreach($pengajuanFinance as $pengajuan)
                                    <tr>
                                        ...
                                        <td class="text-center text-xs">
                                            <a href="{{ route('detail-pengajuan-finance', ['id' => $pengajuan->id]) }}" class="badge badge-pill bg-gradient-info">Detail</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
